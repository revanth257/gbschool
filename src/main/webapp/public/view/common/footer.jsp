...
<footer>
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <!-- Get in Touch -->
            <div class="col-md-4 footer">
                <span style="font-weight: 600;">Get in Touch</span><br>
                <span>12-81/3, Main Rd, opp. Star Clinic Hospital, Nethaji Nagar, Pulaganipalem, Pendurthi, Visakhapatnam, Andhra Pradesh 531173.</span><br>
                <span>+91 9553123333</span><br>
        ...
        <div class="row ">
        	...
        	<span class="footer-links">Terms & Conditions</span>
            <span class="footer-links">Cookies</span>
            <span class="footer-links">FAQ</span>
        	</div>
        	<div class="col-md-4">
        	...
        	<div>Powered By</div>
                <img src="${pageContext.request.contextPath}/public/media/logo/logo.png" alt="KRRSD">
        	</div>
        </div>
    </div>
</footer>
